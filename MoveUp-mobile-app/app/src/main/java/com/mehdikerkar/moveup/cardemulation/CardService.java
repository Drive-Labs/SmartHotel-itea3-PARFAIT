...
public class CardService extends HostApduService {
    ...
    public byte[] processCommandApdu(byte[] commandApdu, Bundle extras) {
        ...
        if (Arrays.equals(SELECT_APDU, commandApdu)) {
            ...
            System.out.println("#########################");
            System.out.println("la cle qui est enregistrer !!"+key);
            System.out.println("#########################");

            //String toSend = hash.toString().substring(0,20);
            System.out.println("KEY:PIN"+key+":"+pin);
            String HAKey = MD5.getMd5(key + pin);
            System.out.println("hash(Key+pin): " + HAKey.substring(0,20));
            //String sub = addChar(HAKey, '0',6);
            //System.out.println("hash(key+pin)&0: " + sub.substring(0,20));

            return ConcatArrays(HAKey.substring(0,20).getBytes(), SELECT_OK_SW);

          //  System.out.println("return:"+ConcatArrays(accountBytes, SELECT_OK_SW));
